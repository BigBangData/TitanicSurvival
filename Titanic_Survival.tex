...
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{nrow}\NormalTok{(train)) \{}
\NormalTok{    pattern <-}\StringTok{ "[0-9]+$"}
\NormalTok{    m <-}\StringTok{ }\KeywordTok{regexec}\NormalTok{(pattern, train}\OperatorTok{$}\NormalTok{Cabin[i])}
\NormalTok{    digits <-}\StringTok{ }\KeywordTok{regmatches}\NormalTok{(train}\OperatorTok{$}\NormalTok{Cabin[i], m)}
\NormalTok{    train}\OperatorTok{$}\NormalTok{CabinClean[i] <-}\StringTok{ }\KeywordTok{trimws}\NormalTok{(}\KeywordTok{sub}\NormalTok{(digits, }\StringTok{""}\NormalTok{, train}\OperatorTok{$}\NormalTok{Cabin[i]), }\DataTypeTok{which=}\StringTok{"right"}\NormalTok{)}
\NormalTok{\}}
\CommentTok{# recategorizing manually, letters higher than F are binned into the F level}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{nrow}\NormalTok{(train)) \{}
\NormalTok{train}\OperatorTok{$}\NormalTok{CabinClean[i] <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(train}\OperatorTok{$}\NormalTok{CabinClean[i] }\OperatorTok{==}\StringTok{ "B51 B53 B"} \OperatorTok{|}\StringTok{ }
\StringTok{                              }\NormalTok{train}\OperatorTok{$}\NormalTok{CabinClean[i] }\OperatorTok{==}\StringTok{ "B57 B59 B63 B"} \OperatorTok{|}\StringTok{ }
\StringTok{                              }\NormalTok{train}\OperatorTok{$}\NormalTok{CabinClean[i] }\OperatorTok{==}\StringTok{ "B58 B"} \OperatorTok{|}\StringTok{ }
\StringTok{                                        }\NormalTok{train}\OperatorTok{$}\NormalTok{CabinClean[i] }\OperatorTok{==}\StringTok{ "B82 B"} \OperatorTok{|}\StringTok{ }
\StringTok{                                        }\NormalTok{train}\OperatorTok{$}\NormalTok{CabinClean[i] }\OperatorTok{==}\StringTok{ "B96 B"}\NormalTok{, }\StringTok{"B"}\NormalTok{,}
                                 \KeywordTok{ifelse}\NormalTok{(train}\OperatorTok{$}\NormalTok{CabinClean[i] }\OperatorTok{==}\StringTok{ "C22 C"} \OperatorTok{|}\StringTok{ }
\StringTok{                                        }\NormalTok{train}\OperatorTok{$}\NormalTok{CabinClean[i] }\OperatorTok{==}\StringTok{ "C23 C25 C"} \OperatorTok{|}\StringTok{ }
\StringTok{                                        }\NormalTok{train}\OperatorTok{$}\NormalTok{CabinClean[i] }\OperatorTok{==}\StringTok{ "C62 C"}\NormalTok{, }\StringTok{"C"}\NormalTok{,                        }
                                 \KeywordTok{ifelse}\NormalTok{(train}\OperatorTok{$}\NormalTok{CabinClean[i] }\OperatorTok{==}\StringTok{ "D10 D"}\NormalTok{, }\StringTok{"D"}\NormalTok{,}
                                 \KeywordTok{ifelse}\NormalTok{(train}\OperatorTok{$}\NormalTok{CabinClean[i] }\OperatorTok{==}\StringTok{ "F E"}\OperatorTok{|}\StringTok{ }
\StringTok{                                        }\NormalTok{train}\OperatorTok{$}\NormalTok{CabinClean[i] }\OperatorTok{==}\StringTok{ "F G"} \OperatorTok{|}\StringTok{ }
\StringTok{                                        }\NormalTok{train}\OperatorTok{$}\NormalTok{CabinClean[i] }\OperatorTok{==}\StringTok{ "G"} \OperatorTok{|}\StringTok{ }
\StringTok{                                        }\NormalTok{train}\OperatorTok{$}\NormalTok{CabinClean[i] }\OperatorTok{==}\StringTok{ "T"}\NormalTok{, }\StringTok{"F"}\NormalTok{,}
\NormalTok{                                 train}\OperatorTok{$}\NormalTok{CabinClean[i]))))}
\NormalTok{\}}
...
\includegraphics{Titanic_Survival_files/figure-latex/unnamed-chunk-14-1.pdf}
...
\includegraphics{Titanic_Survival_files/figure-latex/unnamed-chunk-20-1.pdf}
