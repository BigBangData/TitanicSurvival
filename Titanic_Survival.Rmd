...
One motivating question could be: 

* Do children in third class survive worse than adults in first class?

Below are five panel plots, one for each age group, split by class (the panels), survival (bars) and gender (color within bars). Comparing the percentages of 3rd class children (about 41%) and teens especially (about 25%) who survived to 
