...
## Part 1: Initial Exploratory Data Analysis in R

I will explore the Kaggle Titanic train dataset in R, performing pre-processing as needed which later will be copied into a Python script that succintly performs all essential pre-processing and no EDA. 
