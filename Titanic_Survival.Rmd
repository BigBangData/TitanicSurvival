...
for (i in 1:nrow(train)) {
train$CabinClean[i] <- ifelse(train$CabinClean[i] == "B51 B53 B" | 
                              train$CabinClean[i] == "B57 B59 B63 B" | 
                              train$CabinClean[i] == "B58 B" | 
					                    train$CabinClean[i] == "B82 B" | 
					                    train$CabinClean[i] == "B96 B", "B",
					             ifelse(train$CabinClean[i] == "C22 C" | 
					                    train$CabinClean[i] == "C23 C25 C" | 
					                    train$CabinClean[i] == "C62 C", "C",						
					             ifelse(train$CabinClean[i] == "D10 D", "D",
					             ifelse(train$CabinClean[i] == "F E"| 
					                    train$CabinClean[i] == "F G" | 
					                    train$CabinClean[i] == "G" | 
					                    train$CabinClean[i] == "T", "F",
					             train$CabinClean[i]))))
}
# replace old Cabin
