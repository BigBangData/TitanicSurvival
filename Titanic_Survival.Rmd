...
ggplot(data=train) +
   geom_bar(aes(x=SurvivedFac,y=PclassFac, fill=AgeFac), stat="identity") +
   facet_wrap(aes(PclassFac))+
   labs(x='Survived', y='Count', 
   title='Titanic Survival by Age and Passenger Class')

```



[FIX: not a great plot, use percentages, isolate age groups]
